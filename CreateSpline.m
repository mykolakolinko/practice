function [interpolationSpline] = CreateSpline(points, func, degree, fault = 1, SECreationMethod = 0, SESolvingMethod = 0)
	...
	interpolationSpline = FromSpline(points, func, degree, fault, matrix, SECreationMethod);
end;