...
\author{\vspace{5cm}Виконав: \protect\\ студент 4-го курсу \protect\\ спеціальність !!! \protect\\ ПІБ}
\date{}
\maketitle
\section{Постановка задачі}
Необхідно побудувати інтерполяційний сплайн $S(x, u)$ !!! степеня дефекту 1, з крайовими умовами типу !!!.
\section{Код}
...
Розв'язання системи лінійних рівнянь за допомогою зазначеного в умові методу
